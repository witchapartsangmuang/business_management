...
export class PolicyService {
    ...
    static async createPolicy(data: Policy) {
        ...
        const result = await db.query(
            `INSERT INTO policy (policy_code, policy_name, description, unit, is_active, created_by, created_datetime, updated_by, updated_datetime)
    ...
    static async updatePolicy(data: Policy) {
        ...
        const result = await db.query(
            `UPDATE policy SET policy_code = $1, policy_name = $2, description = $3, unit = $4, is_active = $5, updated_by = $6, updated_datetime = $7 WHERE id = $8 RETURNING id, policy_code, policy_name, description, unit, is_active, created_by, created_datetime, updated_by, updated_datetime`,
