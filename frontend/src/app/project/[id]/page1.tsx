                                        ...
                                        <Tbody>
                                            {project_kpi_list.map((projectKpi, index) => (
                                                <tr key={`project_kpi_list-${index}`}>
                                                    ...
                                                    <td>
                                                        <SearchSelect optionList={kpi_select_list} placeholder={'Select KPI'} defaultSelectedValue={String(projectKpi.kpi_id)} onChange={(value) => { onChangeProjectKpi(index, Number(value)) }} />
                                                    </td>
                                                ...
                                                <tbody>
                                                    {project_other_benefit_list.map((projectKpi, index) => (
                                                        <tr key={`project_other_benefit_list-${index}`}>
                                                            <td>{projectKpi.sequence}</td>
                                                            <td>
                                                                <SearchSelect optionList={other_benefit_select_list} placeholder={'Select Other Benefit'} defaultSelectedValue={String(projectKpi.kpi_id)} onChange={(value) => { onChangeProjectOtherBenefit(index, Number(value)) }} />
                                                            </td>
                    ...
                    {tabOpen === 2 &&
                        <>
                            <div className="col-span-3 mt-3 px-3">
                                ...
                                <SearchSelect optionList={select_project_approver_list} placeholder={'Select Project Approver'} defaultSelectedValue={projectInfo.project_approver} onChange={(value) => setProjectInfo({ ...projectInfo, project_approver: value !== null ? value : '' })} />
                            </div>
                            <div className="col-span-12 mt-3 px-3">
                                <div className="table-wrapper">
                                    <table className="tbl tbl-zebra tbl-sortable">
                                        ...
                                        <tbody>
                                            {
                                                teamMember.map((member, index) => (
                                                    <tr key={index}>
                                                        <td>{index + 1}</td>
                                                        <td><SearchSelect optionList={select_project_member_list} placeholder={'Select Team Member'} defaultSelectedValue={member.empName} onChange={(value) => {
